...
\begin{document}
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.8\textwidth]{evaluation_metrics.png} % Replace with your image filename
	...
	\begin{figure}[h!]
		\centering
		\includegraphics[width=0.8\textwidth]{confusion_matrix.png} % Replace with your image filename
